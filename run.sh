...
./bin/main 0 127.0.0.1 8000  2 127.0.0.1:8001 127.0.0.1:8002 > ${LOG_DIR}/node0.log 2>&1 &
echo "Node 0 started (log: ${LOG_DIR}/node0.log)"

# 启动 Node 1：同理重定向到 node1.log
./bin/main 1 127.0.0.1 8001 10 127.0.0.1:8000 127.0.0.1:8002 > ${LOG_DIR}/node1.log 2>&1 &
echo "Node 1 started (log: ${LOG_DIR}/node1.log)"

# 启动 Node 2：同理重定向到 node2.log
./bin/main 2 127.0.0.1 8002 10 127.0.0.1:8001 127.0.0.1:8000 > ${LOG_DIR}/node2.log 2>&1 &
